...
export const Error400: THTTPErrorInfo = {
   ...
   error: {
      ...
      param: { internalcode: 400010, getmsg: (s: string) => `No se ha entregado el parámetro ${s} en la URL de la petición.` },
      query: { internalcode: 400020, getmsg: (s: string) => `No se ha entregado el parámetro ${s} en el query de la petición.` },
      bodyparam: { internalcode: 400030, getmsg: (s: string) => `No se ha entregado el parámetro ${s} en el body del petición.` },
